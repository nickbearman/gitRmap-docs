...
- *More details on the [options here](options.html).*
...
![If you see a screen like this, there is an update for gitRmap. This has one, there may be more!](images/sync-fork.png)
